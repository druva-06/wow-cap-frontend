...
export default function StudyAustraliaPage() {
  const australiaUniversities = studyAbroadUniversities.filter((uni) => uni.country === "Australia")
  const [currentLogoIndex, setCurrentLogoIndex] = useState(0)
  const logosPerPage = 12
  const totalPages = Math.ceil(australiaUniversities.length / logosPerPage)

  const nextLogos = () => {
    if (currentLogoIndex + logosPerPage < australiaUniversities.length) {
  ...
  const currentLogos = australiaUniversities.slice(currentLogoIndex, currentLogoIndex + logosPerPage)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Join 700K+ international students at world's top universities. Experience world-class education,
                beautiful landscapes, and unlimited career opportunities in the land down under.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-white">AUD 40-75K</div>
            ...
            {/* Right Form */}
            <ModernLeadForm countryName="Australia" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Study in Australia?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why millions of students choose Australia for their higher education journey
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Home to 8 of the world's top 100 universities with innovative teaching methods and cutting-edge
                  research facilities.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Consistently ranked among the world's most liveable cities with excellent healthcare and safety
                  standards.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Graduate work visa for 2-4 years depending on your qualification, providing excellent career
                  opportunities.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  AUD 40M+ in financial aid available. Merit-based and need-based scholarships for international
                  students.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Leading research opportunities with government and industry partnerships providing real-world
                  experience.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl">Multicultural Society</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-center">
                  Welcoming and diverse environment with students from 200+ countries creating a global learning
                  experience.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our 43+ University Partners</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our extensive network of partner universities across Australia
            </p>
          </div>
          ...
          <div className="flex justify-center items-center gap-8">
            ...
            <Button
              ...
              onClick={nextLogos}
              className="flex items-center gap-2 hover:bg-blue-50 bg-transparent"
              disabled={currentLogoIndex + logosPerPage >= australiaUniversities.length}
            >
              Next
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Plan your budget effectively with our comprehensive cost breakdown for studying in Australia
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-gray-900">AUD 40K - 75K</div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-gray-900">AUD 15K - 25K</div>
                    <div className="text-sm text-gray-600">per year</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-gray-900">AUD 18K - 25K</div>
                    <div className="text-sm text-gray-600">per year</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">OSHC - Mandatory</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-gray-900">AUD 600 - 800</div>
                    <div className="text-sm text-gray-600">per year</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 h-full flex flex-col justify-between">
                <div className="space-y-6">
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600 mb-4">Up to AUD 30,000 per year based on academic excellence</p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="flex items-center text-blue-600">
                      ...
                      <span className="font-semibold">Up to 24 hours/week during studies</span>
                    </div>
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Access to AUD 40M+ in scholarships and financial aid opportunities. We help you secure maximum
                      funding.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      96% visa success rate with comprehensive interview preparation and pre-departure orientation.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="aspect-video rounded-lg overflow-hidden mb-4">
                    <iframe
                      src="https://www.youtube.com/embed/ZegcomegkKo"
                      title="Australia University Application Process"
                      className="w-full h-full"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowFullScreen
                    ></iframe>
                  </div>
                  <h5 className="font-semibold text-gray-900 mb-2">Australia University Application Process</h5>
                  <p className="text-sm text-gray-600">
                    Step-by-step guide to applying for top Australian universities and securing admissions
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-8 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-green-600">AUD 40M+</div>
              ...
              <div>
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 font-medium">Data Scientist at Atlassian</p>
                    <p className="text-gray-600">University of Melbourne, MS Data Science</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="text-sm text-gray-600">
                    <span className="font-semibold">Key Achievement:</span> AUD 28K Scholarship + PR Pathway
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                  <div className="text-2xl font-bold text-green-600">AUD 120K</div>
                ...
                <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                  <div className="text-2xl font-bold text-purple-600">AUD 28K</div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-blue-100">15+ years of experience in Australia admissions</p>
            </div>
            <div>
