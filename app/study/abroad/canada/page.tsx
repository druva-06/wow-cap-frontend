...
export default function StudyCanadaPage() {
  const canadaUniversities = studyAbroadUniversities.filter((uni) => uni.country === "Canada")
  const [currentLogoIndex, setCurrentLogoIndex] = useState(0)
  const logosPerPage = 12
  const totalPages = Math.ceil(canadaUniversities.length / logosPerPage)

  const nextLogos = () => {
    if (currentLogoIndex + logosPerPage < canadaUniversities.length) {
  ...
  const currentLogos = canadaUniversities.slice(currentLogoIndex, currentLogoIndex + logosPerPage)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Join 800K+ international students at world's top universities. Experience cutting-edge research, diverse
                culture, and unlimited career opportunities in the great white north.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-white">CAD 25-60K</div>
            ...
            {/* Right Form */}
            <ModernLeadForm countryName="Canada" />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Study in Canada?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why millions of students choose Canada for their higher education journey
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Home to 3 Canadian universities in the global top 50, offering internationally recognized degrees and
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Experience a multicultural society with students from 200+ countries. Build global networks and
                  perspectives in a welcoming environment.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Access to top companies and 3-year post-graduation work permit with pathway to permanent residency.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  CAD 30M+ in financial aid available. Merit-based and need-based scholarships for international
                  students.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl">High Quality of Life</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-center">
                  Consistently ranked among the world's most liveable countries with excellent healthcare and safety.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our 96+ University Partners</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our extensive network of partner universities across Canada
            </p>
          </div>
          ...
          <div className="flex justify-center items-center gap-8">
            ...
            <Button
              ...
              onClick={nextLogos}
              className="flex items-center gap-2 hover:bg-blue-50 bg-transparent"
              disabled={currentLogoIndex + logosPerPage >= canadaUniversities.length}
            >
              Next
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Plan your budget effectively with our comprehensive cost breakdown for studying in Canada
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-gray-900">CAD 25K - 60K</div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-gray-900">CAD 10K - 18K</div>
                    <div className="text-sm text-gray-600">per year</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-gray-900">CAD 12K - 20K</div>
                    <div className="text-sm text-gray-600">per year</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Provincial Health Coverage</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-gray-900">CAD 600 - 900</div>
                    <div className="text-sm text-gray-600">per year</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 h-full flex flex-col justify-between">
                <div className="space-y-6">
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600 mb-4">Up to CAD 25,000 per year based on academic excellence</p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600 mb-4">On-campus and off-campus work authorization</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Access to CAD 30M+ in scholarships and financial aid opportunities. We help you secure maximum
                      funding.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      97% visa success rate with comprehensive interview preparation and pre-departure orientation.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="aspect-video rounded-lg overflow-hidden mb-4">
                    <iframe
                      src="https://www.youtube.com/embed/ZegcomegkKo"
                      title="Canada University Application Process"
                      className="w-full h-full"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowFullScreen
                    ></iframe>
                  </div>
                  <h5 className="font-semibold text-gray-900 mb-2">Canada University Application Process</h5>
                  <p className="text-sm text-gray-600">
                    Step-by-step guide to applying for top Canadian universities and securing admissions
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 mt-8 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-green-600">CAD 30M+</div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div>
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  />
                  <div>
                    <h3 className="text-2xl font-bold text-gray-900">Ravi Kumar</h3>
                    <p className="text-blue-600 font-medium">Software Engineer at Shopify</p>
                    <p className="text-gray-600">University of Toronto, MS Computer Science</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-6">
                  ...
                  <div className="text-sm text-gray-600">
                    <span className="font-semibold">Key Achievement:</span> CAD 20K Scholarship + PR Pathway
                  </div>
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                  <div className="text-2xl font-bold text-green-600">CAD 110K</div>
                ...
                <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                  <div className="text-2xl font-bold text-purple-600">CAD 20K</div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-blue-100">15+ years of experience in Canada admissions</p>
            </div>
            <div>
