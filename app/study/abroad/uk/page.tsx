...
export default function StudyUKPage() {
  const ukUniversities = studyAbroadUniversities.filter((uni) => uni.country === "UK")
  const [currentLogoIndex, setCurrentLogoIndex] = useState(0)
  const logosPerPage = 12
  const totalPages = Math.ceil(ukUniversities.length / logosPerPage)

  const nextLogos = () => {
    if (currentLogoIndex + logosPerPage < ukUniversities.length) {
  ...
  const currentLogos = ukUniversities.slice(currentLogoIndex, currentLogoIndex + logosPerPage)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Join 500K+ international students at world's oldest universities. Experience centuries of academic
                excellence, cutting-edge research, and unlimited career opportunities in the heart of Europe.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-white">£20K-60K</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Study in UK?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover why millions of students choose UK for their higher education journey
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Home to 4 of the world's top 10 universities including Oxford and Cambridge with 800+ years of
                  academic excellence.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  UK degrees are recognized worldwide and highly valued by employers across all industries and
                  countries.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  Access to 2-year post-study work visa and excellent career prospects in Europe's financial hub.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600 text-center">
                  £30+ billion in financial aid available. Merit-based and need-based scholarships for international
                  students.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-xl">Shorter Duration</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 text-center">
                  Complete your Master's in just 1 year and Bachelor's in 3 years, saving time and money.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our 130+ University Partners</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our extensive network of partner universities across the United Kingdom
            </p>
          </div>
          ...
          <div className="flex justify-center items-center gap-8">
            ...
            <Button
              ...
              onClick={nextLogos}
              className="flex items-center gap-2 hover:bg-blue-50 bg-transparent"
              disabled={currentLogoIndex + logosPerPage >= ukUniversities.length}
            >
              Next
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Plan your budget effectively with our comprehensive cost breakdown for studying in UK
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-gray-900">£20K - £60K</div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-gray-900">£12K - £18K</div>
                    <div className="text-sm text-gray-600">per year</div>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">NHS Surcharge</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-bold text-gray-900">£470</div>
                    <div className="text-sm text-gray-600">per year</div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6 h-full flex flex-col justify-between">
                <div className="space-y-6">
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600 mb-4">Up to £25,000 per year based on academic excellence</p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600 mb-4">Part-time work and post-study work authorization</p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Your end-to-end partner for studying in UK with personalized guidance and proven success
            </p>
          </div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Access to £30M+ in scholarships and financial aid opportunities. We help you secure maximum
                      funding.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="aspect-video rounded-lg overflow-hidden mb-4">
                    <iframe
                      src="https://www.youtube.com/embed/ZegcomegkKo"
                      title="UK University Application Process"
                      className="w-full h-full"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowFullScreen
                    ></iframe>
                  </div>
                  <h5 className="font-semibold text-gray-900 mb-2">UK University Application Process</h5>
                  <p className="text-sm text-gray-600">
                    Step-by-step guide to applying for top UK universities and securing admissions
                  </p>
                </div>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Success Stories from UK</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hear from students who made their British dream come true with MeritCap's guidance
            </p>
          </div>
              ...
              <div>
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 font-medium">Software Engineer at Google London</p>
                    <p className="text-gray-600">University of Oxford, MS Computer Science</p>
                  </div>
                </div>
                <blockquote className="text-lg text-gray-700 italic mb-6">
                  "MeritCap made my Oxford dream a reality. From university selection to visa approval, their AI-powered
                  matching and expert guidance were incredible. Now I'm working at Google London with a £85K package and
                  living my best life in the UK!"
                </blockquote>
                <div className="flex items-center space-x-6">
                  ...
                  <div className="text-sm text-gray-600">
                    <span className="font-semibold">Key Achievement:</span> £30K Scholarship + Tier 2 Visa
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 to-blue-800 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of successful students who chose MeritCap for their British dream. Get personalized guidance
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-blue-100">15+ years of experience in UK admissions</p>
            </div>
            <div>
